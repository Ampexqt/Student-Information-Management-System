      ...
      <div className="student-page-container" style={{ flex: 1, position: 'relative' }}>
        ...
        <div className="global-header">
          <div className="global-greeting-time">
            <span className="global-greeting">{getGreeting(currentTime.getHours(), currentTime.getMinutes())}</span>
            <span className="global-time">{currentTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })}</span>
          </div>
        </div>
